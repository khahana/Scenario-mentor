    ...
    try {
      ...
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `You are a professional trading analyst. Reassess this Battle Card setup BRIEFLY (max 100 words):

ASSET: ${card.instrument} (${card.timeframe})
CURRENT PRICE: $${formatPrice(currentPrice)}
24H CHANGE: ${tickerData.changePercent24h?.toFixed(2) || 'N/A'}%
${priceContext}

ORIGINAL THESIS: ${card.thesis || 'Not specified'}
